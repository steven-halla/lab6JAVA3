...
{
    private String fileName = "src/graphs/Graph.txt";
    ...
    {        
        try
        {
            ...
            while(inFile.hasNext())
            {
                ...
                int startingVertex = Integer.parseInt(tokens[0]);
    ...
    {//GEN-HEADEREND:event_newJMenuItemActionPerformed
        try
        {
            ...
            if(choice == JFileChooser.APPROVE_OPTION)
            {
                ...
                fileName = "src/graphs/" + chosen.getName();
    ...
    {//GEN-HEADEREND:event_goJButtonActionPerformed
        ...
        catch(Exception exp)
        {
            JOptionPane.showMessageDialog(null, exp.getMessage(),
                    "Cannot create graph!", JOptionPane.ERROR_MESSAGE);
        }
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    {//GEN-HEADEREND:event_shortestPathJMenuItemActionPerformed
        try
        {
            ...
            {
                int v1 = Integer.parseInt(JOptionPane.showInputDialog("Enter the First vertxt."));
                int v2 = Integer.parseInt(JOptionPane.showInputDialog("Enter the Secods vertxt."));
                goJButton.doClick();
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    public void createGraph()
    {
        ...
        output.append("The number of the vertices is " + numberOfVertices + "\n\n");
